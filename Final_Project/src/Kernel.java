            ...
            case INTERRUPT_SOFTWARE: // System calls
                switch( cmd ) {
                    ...
                    case OPEN:    // to be implemented in project
                        if ((myTcb = scheduler.getMyTcb()) != null) {
                            String[] para = (String[]) args;
                            FileTableEntry entry = fileSystem.open(para[0], para[1]);
                    ...
                    case CLOSE:   // to be implemented in project
                        if ((myTcb = scheduler.getMyTcb()) != null) {
                            FileTableEntry entry = myTcb.returnFd(param);
                            fileSystem.close(entry);
                            return OK;
                        } else {
                            return ERROR;
                        }
                    ...
                    case SEEK:    // to be implemented in project
                        if ((myTcb = scheduler.getMyTcb()) != null) {
                            FileTableEntry entry = myTcb.getFtEnt(param);
                            int[] index = (int[])args;
                            return fileSystem.seek(entry, index[0], index[1]);
                        } else {
                            return ERROR;
                        }
